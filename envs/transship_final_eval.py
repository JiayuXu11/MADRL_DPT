    ...
    def action_map(self, actions):
        ...
        if self.action_type == 'discrete' or self.action_type == 'central_discrete':
            ...
            for i in range(self.agent_num):
                ...
                transship_amount = max(action[i] % (
                    DEMAND_MAX+1)-DEMAND_MAX/2, -self.inventory[i]-self.order[i][0])
        ...
        if self.ratio_transsship:
            ...
            if sum(transship_amounts) < 0:
                ...
                for i in range(len(transship_amounts)):
                    transship_amounts[i] = round(
                        ratio*transship_amounts[i], 0) if transship_amounts[i] < 0 else transship_amounts[i]
