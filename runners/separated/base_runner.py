...
class Runner(object):
    def __init__(self, config):
        ...
        self.hidden_size_critic = self.all_args.hidden_size_critic[-1] if isinstance(self.all_args.hidden_size_critic,list) else self.all_args.hidden_size_critic
        self.hidden_size = self.all_args.hidden_size[-1] if isinstance(self.all_args.hidden_size,list) else self.all_args.hidden_size
