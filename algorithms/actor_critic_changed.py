...
from algorithms.utils.mlp_changed import MLPBase as MLP_changed
...
class Actor(nn.Module):
    ...
    def __init__(self, args, obs_space, action_space, device=torch.device("cpu")):
        ...
        base = MLP_changed
        obs1,obs2,obs3=6,6,1
        self.base1 = base(args, obs1, 12, 1, cat_self=True)
        self.base2 = base(args, obs2, 12, 1, cat_self=True)
        self.base3 = base(args, obs3, 2, 1, cat_self=False)
    ...
    def forward(self, obs, rnn_states, masks, available_actions=None, deterministic=False):
        ...
        obs1= obs[:,0:6]
        actor_features_1 = self.base1(obs1)
        obs2= obs[:,6:12]
        actor_features_2 = self.base2(obs2)
        obs3= obs[:,[-1]]
        actor_features_3 = self.base3(obs3)
        actor_features= torch.cat((actor_features_1,actor_features_2,actor_features_3),-1)
        actor_features = self.base4(actor_features)
        if self._use_naive_recurrent_policy or self._use_recurrent_policy:
