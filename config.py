...
def get_config():
    ...
    parser.add_argument("--seed", type=int, 
                        default=[0, 1, 2, 3, 4, 5], help="Random seed for numpy/torch")
    ...
    parser.add_argument("--yaml_path", type=str, 
                        default='setting_yaml/discrete/discrete_test.yaml', help="yaml的路径")
   #  parser.add_argument("--yaml_path", type=str, 
   #                      default=None, help="yaml的路径")
    ...
    parser.add_argument("--reward_type", type=str, 
                        default='reward', choices=['cost', 'reward', 'norm_cost'], help="reward 是什么")
